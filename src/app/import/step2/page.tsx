import Verification from "@/components/imports/verification";
import React from "react";

const page: React.FC = () => {
  return (
    <div className="flex flex-col bg-[#6896D3] mx-[12rem] items-center h-[80%] mt-20 w-[80%] border-rose-800 p-6 ">
      ...
      <div className=" w-full h-full flex flex-col items-center justify-between">
        ...
        <div className="w-[80%] h-[80%] flex flex-col py-5">
